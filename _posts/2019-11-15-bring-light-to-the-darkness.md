...
- Radare2 doesn't display instruction packets and without those brackets, it's basically useless
...
- Ghidra hasn't got IDE support for the instruction packet brackets. @NeatMonster showed that a hexagon plugin is
